# https://www.ijraset.com/research-paper/sudoku-solving-using-quantum-computer
...
qc = QuantumCircuit(a_string, b_string, c_string, d_string, 
                    all_0_ancilla_ab, all_0_ancilla_cd, 
                    all_0_ancilla_ac, all_0_ancilla_bd, 
                    out, classical)
...
for i in range (n):
    oracle(qc)
    qc.mct([all_0_ancilla_ab[1], all_0_ancilla_ac[1], 
            all_0_ancilla_cd[1], all_0_ancilla_bd[1]], out)
